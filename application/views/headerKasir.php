    ...
    <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="<?php echo base_url('berandaKasir');?>" class="logo"><i class="ion-ios7-world icon-c-logo"></i><span>Ar Printing</span></a>
                        <!-- Image Logo here -->
...
.
.                            <li class="has_sub">
                                <a href="<?php echo base_url('kasir/welcome'); ?>" class="waves-effect"><i class="ti-home"></i>
                            ...
                            <li class="has_sub">
                                <a href="<?php echo base_url('kasir/TransaksiControllerkasir'); ?>" class="waves-effect"><i class="ti-money"></i>  Transaksi Penjualan</a>
