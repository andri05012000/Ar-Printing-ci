...
<div class="row">
    <div class="col-sm-12">
        ...
        <form action="<?php echo base_url(). 'admin/DetailTransaksiController/add'; ?>" method="post" class="form-horizontal" role="form">
            <div class="col-md-6">
...
<div id="cetak-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        ...
        <form action="<?php echo base_url(). 'admin/TransaksiController/updateHarga'; ?>" method="post" class="form-horizontal" role="form"> 
...
<div id="delete-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog" style="width:55%;">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?php echo base_url(). 'admin/DetailTransaksiController/delete'; ?>" method="post" class="form-horizontal" role="form">
                                                    <div class="modal-body">
